...
function restoreUserData() {
    ...
    console.log('Данные из URL:', urlData);
    console.log('Данные из localStorage:', savedData ? JSON.parse(savedData) : 'нет');
    ...
    // Если нет данных в URL, но есть в localStorage
    if (savedData) {
        try {
            const parsedData = JSON.parse(savedData);
            console.log('✅ Данные восстановлены из localStorage:', parsedData);
